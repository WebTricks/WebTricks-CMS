WebTricks.Controls.StartMenu = Ext.extend(Ext.menu.Menu, 
{
    initComponent: function(config) 
    {
    	WebTricks.Controls.StartMenu.superclass.initComponent.call(this, config);
    ...
    {
        WebTricks.Controls.StartMenu.superclass.onRender.call(this, ct, position);
