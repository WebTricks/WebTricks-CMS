WebTricks.Controls.TaskBar = function(app)
{
    this.app = app;
    this.init();
}

Ext.extend(WebTricks.Controls.TaskBar, Ext.util.Observable, 
{
    init : function()
    {
        this.startMenu = new WebTricks.Controls.StartMenu(Ext.apply({
            iconCls: 'user',
            height: 300,
            shadow: true,
            title: 'Jack Slocum',
...
Ext.ux.TaskButtonsPanel = Ext.extend(Ext.BoxComponent, {
    ...
    addButton : function(win){
        ...
        var btn = new WebTricks.Controls.TaskBar.TaskButton(win, li);
...
WebTricks.Controls.TaskBar.TaskButton = function(win, el)
{
    this.win = win;
    WebTricks.Controls.TaskBar.TaskButton.superclass.constructor.call(this, {
        iconCls: win.iconCls,
        text: Ext.util.Format.ellipsis(win.title, 40),
        renderTo: el,
        handler : function(){
...
Ext.extend(WebTricks.Controls.TaskBar.TaskButton, Ext.Button, {
    onRender : function(){
		WebTricks.Controls.TaskBar.TaskButton.superclass.onRender.apply(this, arguments);
