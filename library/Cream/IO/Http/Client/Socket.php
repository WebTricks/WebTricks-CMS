 ...
 */
class Cream_IO_Http_Client_Socket implements Cream_IO_Http_Client_Interface
{
	/**
	 * Hostname
	 * 
	 ...
	 * 
	 * @return Cream_IO_Http_Client_Socket
	 */
	public static function instance($host = null, $port = 80)
	{
		return Cream::instance(__CLASS__, $host, $port);
	}
	 ...
	 * @param int $port
	 */
	public function __init($host = null, $port = 80)
	{
		if($host) {
