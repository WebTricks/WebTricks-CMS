 ...
 */
class Cream_Security_Domains_Data_Manager extends Cream_ApplicationComponent
{
	/**
	...
	{
		$className = Cream_Utility::ucWords($config->data_manager);
		$dataManager = Cream::instance('Cream_Security_Domains_Data_Manager_'. $className, $config);
