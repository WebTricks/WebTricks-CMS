...
/**
 * Class to create correct SQL insert statements
 *
 * @package		Cream_Data_Statement
 * @author		Danny Verkadeu
 */
class Cream_Data_Statement_Insert extends Cream_Data_Statement
{
	/**
	 * Create an instance of this class
	 *
	 * @return Cream_Data_Statement_Insert
	 */
	...
	/**
	 * Set the values to insert in the table. Accepts an array, where the keys
