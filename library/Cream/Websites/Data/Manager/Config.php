 ...
 */
class Cream_Websites_Data_Manager_Config extends Cream_Websites_Data_Manager_Abstract
{
	/**
	 ...
	 * 
	 * @return Cream_Websites_Data_Manager_Config
	 */
	...
	{
		$config = $this->getApplication()->getConfig()->getNode(self::CONFIG_PATH_SITES);
