...
class Cream_Market_Config implements Iterator
{
	 ...
	 */
	public static function instance($configFile = "connect.cfg")
	{
		return Cream::instance(__CLASS__, $configFile);
	}
	 ...
	 * @return void
	 */
    public function __init($configFile = "connect.cfg")
    {
        $this->initProperties();
        ...
        $this->properties = array (
           ...
           'global_file_mode' => array (
            ...
            'downloader_path' => array(
                'type' => 'dir',
                'value' => 'downloader',
                'prompt' => 'relative path, location of downloader',
                'doc' => "relative path, location of downloader",
                'possible' => 'path',
        ),
            'webtricks_root' => array(
                'type' => 'dir',
                'value' => '',
                'prompt' => 'location of root dir',
                'doc' => "Location of WebTricks",
                'possible' => '/path',
        ),
            'root_channel' => array(
                'type' => 'string',
    ...
    {
        return $this->webtricks_root . DIRECTORY_SEPARATOR . $this->downloader_path;
    }
