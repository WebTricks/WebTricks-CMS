 ...
 *
 */
class Cream_Url extends Cream_ApplicationComponent
{
    ...
    {
        $this->_setData('use_url_cache', $flag);
        return $this;
    }
    ...
    {
        $this->_setData('route_front_name', $name);
        return $this;
    }
    ...
    {
        if (!$this->_hasData('type')) {
            $this->_setData('type', 'link');
        }
    ...
    {
        if ($this->_hasData('secure_is_forced')) {
    ...
    {
        $this->_setData('store', Mage::app()->getStore($data));
        return $this;
    }
    ...
    public function setRoutePath($data)
    {
        ...
        #$this->_setData('route_path', $routePath);
    }
    ...
    {
        if (!$this->_hasData('route_path')) {
            $routePath = $this->getRequest()->getAlias('test');
    ...
    public function setRouteName($data)
    {
        ...
        $this->_unsetData('route_front_name');
        $this->_unsetData('route_path');
        $this->_unsetData('controller_name');
		$this->_unsetData('action_name');
		$this->_unsetData('secure');
        return $this->_setData('route_name', $data);
    }
    ...
    public function setControllerName($data)
    {
        ...
        $this->_unsetData('action_name');
        $this->_unsetData('secure');
        return $this->_setData('controller_name', $data);
    }
    ...
    public function setActionName($data)
    {
        ...
        $this->_unsetData('route_path');
        $this->_setData('action_name', $data);
        $this->_unsetData('secure');
    }
    ...
    public function setRouteParam($key, $data)
    {
        ...
        $params[$key] = $data;
        $this->_unsetData('route_path');
        return $this->_setData('route_params', $params);
    }
    ...
    public function setQueryParams(array $data)
    {
        ...
        $this->_setData('query_params', $params);
    }
    ...
    {
        $this->_setData('query_params', array());
        return $this;
    }
    ...
    public function setQueryParam($key, $data)
    {
        ...
        $params[$key] = $data;
        $this->_unsetData('query');
        return $this->_setData('query_params', $params);
    }
    ...
    {
        return $this->_setData('fragment', $data);
    }
    ...
    public function useSessionIdForUrl($secure = false)
    {
        ...
        if (is_null($this->_getData($key))) {
            ...
            if ($httpHost != $urlHost) {
                $this->_setData($key, true);
            }
            else {
                $this->_setData($key, false);
            }
        }
