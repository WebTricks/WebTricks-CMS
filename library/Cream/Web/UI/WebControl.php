...
abstract class Cream_Web_UI_WebControl extends Cream_Web_UI_Control
{
    ...
    public function getRequest()
    {
        ...
        if ($controller) {
            ...
            throw new Cream_Exceptions_Exception("Can't retrieve request object");
        }
     ...
     * @return  void
     */
    public function setParentBlock(Cream_Web_UI_Control $block)
    {
     ...
     * @return  void
     */
    public function setLayout(Cream_Layout $layout)
    {
        $this->_layout = $layout;
        $this->_prepareLayout();
    }
     ...
     *
     * @param   string $name
     * @param   Cream_Web_UI_Control $child
     */
    protected function _beforeChildToHtml($name, Cream_Web_UI_Control $child)
    {
    }
     ...
     * Insert child block
     *
     * @param   Cream_Web_UI_Control|string $block
     ...
     * @return  void
     */
    public function append(Cream_Web_UI_Control $block, $alias='')
    {
     ...
     * @param Cream_Web_UI_Control $child
     */
    public function addToChildGroup($groupName, Cream_Web_UI_Control $child)
    {
    ...
    {
        $module = $this->_getData('module_name');
        if (is_null($module)) {
            $class = get_class($this);
            $module = substr($class, 0, strpos($class, '_Block'));
            $this->_setData('module_name', $module);
        }
        return $module;
    }
    ...
    {
        if ($this->_hasData('cache_key')) {
            return $this->_getData('cache_key');
        }
        /**
    ...
    {
        if (!$this->_hasData('cache_tags')) {
            $tags = array();
        } else {
            $tags = $this->_getData('cache_tags');
        }
    ...
    {
        //if (!$this->_hasData('cache_lifetime')) {
        //    return null;
        //}
        //return $this->_getData('cache_lifetime');
    }
