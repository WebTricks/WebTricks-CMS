 ...
 */
class Cream_Web_UI_ExtControls_Chart_TimeAxis extends Cream_Web_UI_ExtControls_Chart_Axis
{
	/**
	 * Create a new instance of this class
	 *
	 * @return Cream_Web_UI_ExtControls_Chart_TimeAxis
	 */
	...
	{
		$this->setControl('Ext.chart.TimeAxis');
	}
		
	/**
	 * The time unit used by the majorUnit.
	 *
	 * @param integer $majorTimeUnit
	 */
	public function setMajorTimeUnit($majorTimeUnit)
	{
		$this->setAttribute('majorTimeUnit', $majorTimeUnit);
	}

	/**
	 * The time unit used by the minorUnit.
	 *
	 * @param integer $manorTimeUnit
	 */
	public function setManorTimeUnit($manorTimeUnit)
	{
		$this->setAttribute('manorTimeUnit', $manorTimeUnit);
	}
