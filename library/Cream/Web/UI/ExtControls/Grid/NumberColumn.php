 ...
 * format string. See the xtype config option of Ext.grid.Column for more 
 * details.
 *
 * @package 	Cream_Web_UI_ExtControls_Grid
 * @author 		Danny Verkade
 */
class Cream_Web_UI_ExtControls_Grid_NumberColumn extends Cream_Web_UI_ExtControls_Grid_Column
{
	/**
	...
	{
		$this->setControl('Ext.grid.NumberColumn');
		$this->setXtype('numbercolumn');
	}
