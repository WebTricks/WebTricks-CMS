 ...
 * config option of Ext.grid.Column for more details.
 *
 * @package 	Cream_Web_UI_ExtControls_Grid
 * @author 		Danny Verkade
 */
class Cream_Web_UI_ExtControls_Grid_BooleanColumn extends Cream_Web_UI_ExtControls_Grid_Column
{
	/**
	...
	{
		$this->setControl('Ext.grid.BooleanColumn');
		$this->setXtype('booleancolumn');
	}
