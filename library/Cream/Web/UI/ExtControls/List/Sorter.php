 ...
 */
class Cream_Web_UI_ExtControls_List_Sorter extends Cream_Web_UI_ExtControls_Util_Observable
{
	/**
	 * Create a new instance of this class
	 *
	 * @return Cream_Web_UI_ExtControls_List_Sorter
	 */
	...
	{
		$this->setControl('Ext.list.Sorter');
	}
