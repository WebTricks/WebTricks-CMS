 ...
 * Ext.list.Column for more details.
 *
 * @package 	Cream_Web_UI_ExtControls_List
 * @author 		Danny Verkade
 */
class Cream_Web_UI_ExtControls_List_DateColumn extends Cream_Web_UI_ExtControls_List_Column
{
	/**
	 * Create a new instance of this class
	 *
	 * @return Cream_Web_UI_ExtControls_List_DateColumn
	 */
	...
	{
		$this->setControl('Ext.list.DateColumn');
	}
}