...
/**
 * Sorting comparer based on the display name of the items.
 *
 * @package		Cream_Content_Fields
 * @author		Danny Verkade
 */
class Cream_Content_Sorting_DisplayNameComparer implements Cream_Content_Sorting_ComparerInterface
{
	/**
