 ...
 *
 * @package		Cream_Content_Links_Data_Manager
 * @author		Danny Verkade
 */
class Cream_Content_Links_Data_Manager extends Cream_ApplicationComponent
{
	/**
	...
	public static function factory(Cream_Config_Xml_Element $config)
	{
		...
		$manager = Cream::instance('Cream_Content_Links_Data_Manager_'. $className, $config);
