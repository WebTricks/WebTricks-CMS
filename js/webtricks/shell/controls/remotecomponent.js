...
Ext.namespace('WebTricks', 'WebTricks.Shell', 'WebTricks.Shell.Controls');

WebTricks.Shell.Controls.RemoteComponent = function (config)
{
   /**
...
Ext.extend(WebTricks.Shell.Controls.RemoteComponent, Ext.util.Observable);