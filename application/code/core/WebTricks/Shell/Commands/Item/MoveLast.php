...
/**
 * Command class for moving the item to the bottom.
 *
 * @package		WebTricks_Shell
 * @author		WebTicks Core Team <core@webtricksframework.com>
 */
class WebTricks_Shell_Commands_Item_MoveLast extends WebTricks_Shell_Commands_Command
{	
	/**
	 * Execute the command.
	 * 
