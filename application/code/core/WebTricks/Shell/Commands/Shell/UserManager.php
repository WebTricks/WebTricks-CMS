...
class WebTricks_Shell_Commands_Shell_UserManager extends WebTricks_Shell_Commands_Command
{
	const APPLICATION_PATH = 'WebTricks/content/Applications/Security/User Manager';
