...
class WebTricks_Shell_Commands_Shell_Search extends WebTricks_Shell_Commands_Command
{
	const APPLICATION_PATH = 'WebTricks/content/Applications/Search/Search';
